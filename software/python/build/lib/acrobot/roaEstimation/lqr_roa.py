...
from vis import TIrhoVerification, getEllipsePatch

robot = "acrobot"

if robot == "acrobot":
  yaml_paths = ["data/acrobot/roaParameters/CMA-ES_design1st.yml"]
  # ["data/acrobot/roaParameters/CMA-ES_controller1st.yml",
  #                   "data/acrobot/roaParameters/CMA-ES_design1st.yml",
  #                   "data/acrobot/roaParameters/CMA-ES_combined.yml",
  #                   "data/acrobot/roaParameters/NM_controller1st.yml",
  #                   "data/acrobot/roaParameters/NM_design1st.yml"]
  designLabels = ["CMA-ES_design1st"]
  # ["CMA-ES_controller1st",
  #               "CMA-ES_design1st",
  #               "CMA-ES_combined",
  #               "NM_controller1st",
  #               "NM_design1st"]
elif robot == "pendubot":
  yaml_paths = ["data/acrobot/roaParameters/pendubot_params.yml"]
  designLabels = [""]
...
for i,yaml_path in enumerate(yaml_paths):
  ...
  for j,be in enumerate(roa_backends):
    ...
    # plant = SymbolicDoublePendulum( mass         = design_params["m"]      ,
    #                                 length       = design_params["l"]      ,
    #                                 com          = design_params["lc"]     ,
    #                                 damping      = design_params["b"]      ,
    #                                 coulomb_fric = design_params["fc"]     ,
    #                                 gravity      = design_params["g"]      ,
    #                                 inertia      = design_params["I"]      ,
    #                                 torque_limit = design_params["tau_max"]
    #                                 )
    # controller = LQRController( mass         = design_params["m"]      ,
    #                             length       = design_params["l"]      ,
    #                             com          = design_params["lc"]     ,
    #                             damping      = design_params["b"]      ,
    #                             coulomb_fric = design_params["fc"]     ,
    ...
    # Verification script with simulations TODO
    # nVerifications = 100
    # TIrhoVerification(plant,controller,rho_f,nVerifications)
